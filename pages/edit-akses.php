<?php
  ...
  $hasil = $proses->tampil_data_id('roles','role_id',$idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_akses.php?aksi=edit" class="text-start">
                    <div class="input-group input-group-outline my-3">
                      <label class="form-label">Nama Akses</label>
                      <input name="name" type="text" class="form-control"  value="<?php echo $hasil['role_name'];?>"/>
                    </div>
                     <div class="input-group input-group-outline my-3">
                      <label class="form-label">Keterangan</label>
                      <input name="keterangan" type="text" class="form-control"  value="<?php echo $hasil['description'];?>"/>
                    </div>
                    <input type="hidden" value="<?php echo strip_tags($_GET['id']); ?>" class="form-control" name="id_akses" required>
