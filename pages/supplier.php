      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">List Supplier</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">List Supplier</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/add-supplier.php">Tambah Supplier</a>
            </li>
          </ul>
        </div>
      </div>
                  ...
                  <tbody>
                     ...
                     foreach($hasil as $isi){
                      ...
                      <tr>
                        ...
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $isi['contact_name']?></p>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $isi['contact_phone']?></p>
                        </td>
                         <td>
                          <div class="d-flex flex-row justify-content-center gap-2">
                            <a href="../pages/edit-supplier.php?id=<?php echo $isi['supplier_id'];?>" class="btn bg-gradient-warning">
                            <span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/crud_supplier.php?aksi=hapus&hapusid=<?php echo $isi['supplier_id'];?>" 
