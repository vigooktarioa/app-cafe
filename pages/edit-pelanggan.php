<?php
  ...
  $hasil = $proses->tampil_data_id('customers', 'pelanggan_id', $idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_pelanggan.php?aksi=edit" class="text-start">
                    <div class="input-group input-group-outline my-3">
                      <label class="form-label">First Name</label>
                      <input name="first" type="text" class="form-control" value="<?php echo $hasil['firstname'];?>"/>
                    </div>
                    <div class="input-group input-group-outline my-3">
                      <label class="form-label">Last Name</label>
                      <input name="last" type="text" class="form-control" value="<?php echo $hasil['lastname'];?>"/>
                    </div>
                     <div class="input-group input-group-outline my-3">
