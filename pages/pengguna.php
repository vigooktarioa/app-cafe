  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/pengguna.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">List Pengguna</li>
          </ol>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/add-user.php">Tambah Pengguna</a>
            </li>
          </ul>
        </div>
      </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Depan</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Belakang</th>
                  ...
                  <tbody>
                     <?php
                     $no=1;
                     $hasil = $proses->tampil_data('users');
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?php echo $isi['username']?></h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $isi['first_name']?></p>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $isi['last_name']?></p>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $isi['phone_number']?></p>
                        </td>
                        <td>
                          <p class="text-xs text-secondary mb-0"><?php echo $isi['address']?></p>
                        </td>
                        <td>
                            <div class="d-flex justify-content-center">
                                <span class="badge badge-sm bg-gradient-success">
                                <?php 
                                $hasil = $proses->join_data('users', 'roles', 'role_id', $isi['role_id']);
                                echo '<span class="badge badge-sm bg-gradient-success">' . $hasil['role_name'] . '</span>';
                                ?>
                                </span>
                            </div>
                        </td>
                        <td>
                          <div class="d-flex flex-row justify-content-center gap-2">
                            <a href="../pages/edit-user.php?id=<?php echo $isi['pengguna_id'];?>" class="btn bg-gradient-warning">
                            <span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/crud.php?aksi=hapus&hapusid=<?php echo $isi['pengguna_id'];?>" 
