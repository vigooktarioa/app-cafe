        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
                <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/add-item.php?id=<?php echo intval($_GET['id']); ?>">Tambah Item</a>
            </li>
          </ul>
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
                <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/penjualan.php">Back</a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $hasil = $proses->tampil_data_where('detail_transaksi', 'transaksi_id', $idGet);
                      ...
                      <tr>
                          ...
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                             <h6 class="mb-0 text-sm"> 
                                <?php 
                                  $hasil = $proses->join_data('detail_transaksi', 'barang', 'barang_id', $isi['barang_id']);
                                  echo  $hasil['name'];
                                ?>
                                </h6>
                            </div>
                        ...
                        <td>
                          <div class="d-flex flex-row justify-content-center gap-2">
                            <a href="../pages/edit-item.php?id=<?php echo $isi['detail_id'];?>" class="btn bg-gradient-warning">
                            <span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/crud_transaksi.php?aksi=hapus_detail&id=<?php echo intval($_GET['id']);?>&hapusid=<?php echo $isi['detail_id'];?>" 
