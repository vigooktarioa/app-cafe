<?php
  ...
  $hasil = $proses->tampil_data_id('inventory','id',$idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_pasokan.php?aksi=edit" class="text-start">
                    <div class="d-flex flex-column">
                        <label class="form-label input-group input-group-outline" for="barang">Choose a barang:</label>
                    ...
                    <div class="d-flex flex-column">
                        <label class="form-label input-group input-group-outline" for="access">Choose a supplier:</label>
                    ...
                    <div class="input-group input-group-outline my-3">
                      ...
                      <input name="level" type="text" class="form-control" value="<?php echo $hasil['reorder_level'];?>" />
                    </div>
                     <div class="input-group input-group-outline my-3">
                      <label class="form-label">Reorder QTY</label>
                      <input name="level_qty" type="number" class="form-control" value="<?php echo $hasil['reorder_quantity'];?>"  />
                    </div>
                     <div class="input-group input-group-outline my-3">
                      <label class="form-label">Tanggal Restock</label>
                      <input name="date" type="date" class="form-control" autofocus value="<?php echo $hasil['last_restock_date'];?>" />
                    </div>
