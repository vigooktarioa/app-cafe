  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/barang.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">dashboard</i>
            </div>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" href="../pages/add-barang.php">Tambah Barang</a>
            </li>
          </ul>
        </div>
      </div>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-3 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?php echo $isi['name']?></h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo  $isi['category']?></p>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0"><?php echo 'Rp' . $isi['price']?></p>
                        </td>
                        <td>
                          <div class="d-flex justify-content-center">
                            <span class="badge badge-sm bg-gradient-success">
                                <?php 
                                $hasil = $proses->join_data('barang', 'supplier', 'supplier_id	', $isi['supplier_id']);
                                echo '<span class="badge badge-sm bg-gradient-success">' . $hasil['name'] . '</span>';
                                ?>
                                </span>
                            </div>
                        </td>
                        <td>
                          <div class="d-flex flex-row justify-content-center gap-2">
                            <a href="../pages/edit-barang.php?id=<?php echo $isi['barang_id'];?>" class="btn bg-gradient-warning">
                            <span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/crud_barang.php?aksi=hapus&hapusid=<?php echo $isi['barang_id'];?>" 
