<?php
  ...
  $hasil = $proses->tampil_data_id('detail_transaksi', 'detail_id', $idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_transaksi.php?aksi=edit_detail" class="text-start">
                   <div class="d-flex flex-column">
                    <label class="form-label input-group input-group-outline" for="barang">Pilih Pembeli:</label>
                     ...
                     <div class="input-group input-group-outline my-3">
                      ...
                      <input name="qty" type="text" class="form-control" value="<?php echo $hasil['quantity'];?>" />
                    </div>
