<?php
  ...
  $hasil = $proses->tampil_data_id('barang', 'barang_id', $idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_barang.php?aksi=edit" class="text-start">
                    <div class="input-group input-group-outline my-3">
                      <label class="form-label">Name</label>
                      <input name="name" type="text" class="form-control" value="<?php echo $hasil['name'];?>"/>
                    </div>
                    <div class="input-group input-group-outline my-3">
                      <label class="form-label">Category</label>
                      <input name="category" type="text" class="form-control" value="<?php echo $hasil['category'];?>"/>
                    </div>
                     <div class="input-group input-group-outline my-3">
                      <label class="form-label">Price</label>
                      <input name="price" type="text" class="form-control" value="<?php echo $hasil['price'];?>"/>
                    </div>
                     <div class="d-flex flex-column">
                        <label class="form-label input-group input-group-outline" for="supplier">Choose a supplier:</label>
