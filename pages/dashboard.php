...
$total_penjualan = $proses->total_penjualan();
$total_pembelian = $proses->total_pembelian();
?>
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="my-4"><?php echo 'Rp '.$total_pembelian; ?></h4>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                ...
                <h4 class="my-4"><?php echo 'Rp '.$total_penjualan; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Keuntungan</p>
                <h4 class="mb-0"><h4 class="my-4"><?php echo 'Rp ' . $total_penjualan -  $total_pembelian?></h4></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Kerugian</p>
                <h4 class="mb-0"><h4 class="my-4"><?php echo 'Rp ' . $total_pembelian -  $total_penjualan?></h4></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
      ...
      <!-- <div class="row mt-4 style="<?php echo $accessLevel == 'Admin' ? '' : 'display: none;'; ?>"">
