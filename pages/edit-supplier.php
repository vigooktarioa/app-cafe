<?php
  ...
  $hasil = $proses->tampil_data_id('supplier', 'supplier_id', $idGet);
?>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-8 col-12 mx-auto">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="../proses/crud_supplier.php?aksi=edit" class="text-start">
                    ...
                    <div class="input-group input-group-outline my-3">
                      ...
                      <input name="contact" type="text" class="form-control" value="<?php echo $hasil['contact_name'];?>"/>
                    </div>
                     <div class="input-group input-group-outline my-3">
                      <label class="form-label">No HP</label>
                      <input name="nomor" type="text" class="form-control" value="<?php echo $hasil['contact_phone'];?>"/>
                    </div>
